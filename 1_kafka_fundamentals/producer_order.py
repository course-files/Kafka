...
# by Confluent (https://www.confluent.io/product/stream/).
# It provides a high-performance API for producing and consuming Kafka messages.
...
# If delivery fails, the error is logged so that we can investigate further.
